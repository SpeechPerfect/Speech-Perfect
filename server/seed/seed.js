...
async function seed() {
  ...
  const awsReports = await Promise.all([
    AwsReport.create({
      url: 'https://s3.amazonaws.com/speech-perfect/1521563302261',
      speechId: 1
    }),
    AwsReport.create({
      url: 'https://s3.amazonaws.com/speech-perfect/1521498174989',
      speechId: 2
    }),
    AwsReport.create({
      url: 'https://s3.amazonaws.com/speech-perfect/1521490159387',
      speechId: 3
    }),
    AwsReport.create({
      url: 'https://s3.amazonaws.com/speech-perfect/1521489804188',
      speechId: 4
    }),
    AwsReport.create({
      url: 'https://s3.amazonaws.com/speech-perfect/1521563302261',
