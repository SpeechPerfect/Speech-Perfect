...
class TranscriptScreen extends Component {
  ...
  renderSpeech() {
    ...
    let result = []
    let badWords = ['%hesitation','like','A little bit', 'just', 'My topic is', "I've been asked to speak about", 'so', 'actually', 'basically', 'supposedly', 'totally','you know', 'like I said']
