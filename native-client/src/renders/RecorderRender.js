...
import { Uploader, Timer } from '../components/'
...
const RenderBegin = props => {
  return props.begin ? (
    ...
    <View style={styles.recorderBottomText}>
      <Text style={styles.recorderIntroText}>
        {' '}
      ...
      <Text style={styles.recorderText}>
        {' '}
        provide you with suggestions on how to improve{' '}
      </Text>
    </View>
  )
}
  ...
  return (
    <View style={styles.recorderIntroText}>
      <Text style={styles.recorderStopText}>
        {' '}
        Press the mic to stop recording{' '}
      </Text>
    </View>
  )
}
